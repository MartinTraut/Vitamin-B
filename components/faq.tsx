...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Ein Logo Projekt dauert in der Regel zwei bis drei Wochen, eine Website vier bis acht Wochen, ein komplettes Corporate Design vier bis sechs Wochen. Wir besprechen den Zeitrahmen immer vorab und halten uns daran.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Im ersten Schritt nur Ihre Zeit für ein Gespräch. Wir stellen die richtigen Fragen, um Ihr Unternehmen und Ihre Ziele zu verstehen. Vorhandene Materialien wie Logo, Texte oder Fotos sind hilfreich, aber nicht zwingend erforderlich.",
  },
  {
          ...
          {faqs.map((faq, i) => (
            ...
            >
              <Accordion type="single" collapsible>
                <AccordionItem
                  value={`faq-${i}`}
                  className="border border-white/5 rounded-xl px-6 bg-white/[0.02] hover:border-[#ff6a00]/10 transition-all duration-500 data-[state=open]:border-[#ff6a00]/20 data-[state=open]:bg-white/[0.03]"
                >
                  <AccordionTrigger className="text-left text-white hover:text-[#ff6a00] transition-colors py-5 text-base font-medium [&>svg]:text-[#ff6a00] [&>svg]:transition-transform [&>svg]:duration-300">
                    {faq.question}
                  </AccordionTrigger>
