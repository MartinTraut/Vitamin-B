...
export function Hero() {
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 text-center pt-20 pb-24 md:pt-0 md:pb-0">
        <motion.div
        ...
        <motion.h1
          ...
          className="text-[2.5rem] leading-[0.95] sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-6 md:mb-8"
        ...
        <motion.p
          ...
          className="text-base md:text-xl text-white/60 max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed px-2"
        >
        ...
        <motion.div
          ...
          className="mt-12 md:mt-20 flex flex-wrap items-center justify-center gap-4 md:gap-8 text-white/30 text-xs md:text-sm"
        >
          <div className="flex items-center gap-2">
            <span className="text-[#ff6a00] text-xl md:text-2xl font-bold">50+</span>
            <span>zufriedene Kunden</span>
          </div>
          <div className="w-px h-4 md:h-6 bg-white/10" />
          <div className="flex items-center gap-2">
            <span className="text-[#ff6a00] text-xl md:text-2xl font-bold">8+</span>
            <span>Jahre Erfahrung</span>
          </div>
          <div className="w-px h-4 md:h-6 bg-white/10" />
          <div className="flex items-center gap-2">
            <span className="text-[#ff6a00] text-xl md:text-2xl font-bold">100%</span>
      ...
      >
        <a href="#leistungen" className="flex flex-col items-center gap-2 text-white/30 hover:text-[#ff6a00] transition-colors">
          <span className="text-[10px] md:text-xs tracking-widest uppercase">Entdecken</span>
          <ChevronDown className="h-4 w-4 md:h-5 md:w-5 animate-bounce" />
        </a>
      </motion.div>
    </section>
  )
