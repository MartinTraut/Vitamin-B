...
// Interaktives Dot-Feld (pures Canvas, cursor-reaktiver Bulge).
// Quelle: react-bits (ts-tailwind/Backgrounds/DotField), an Brand-Orange angepasst.
...
const DotField = memo(
  ({
    ...
    sparkle = true,
    waveAmplitude = 0,
    gradientFrom = "rgba(227, 152, 50, 0.42)",
    gradientTo = "rgba(227, 152, 50, 0.12)",
    glowColor = "rgba(227, 152, 50, 0.16)",
    ...rest
  }: DotFieldProps) => {
